...
plt.legend(loc='upper center',
    handlelength=0.8,
    columnspacing=0.8,
    ncol=4, bbox_to_anchor=(0.5, 1.2), frameon=False)
...
plt.minorticks_on()
plt.gca().xaxis.set_minor_locator(ticker.AutoMinorLocator(1))
plt.gca().yaxis.set_minor_locator(ticker.AutoMinorLocator(2))
plt.grid(which='major', linestyle='-', linewidth='0.3', color='gray', alpha=0.5)
plt.grid(which='minor', linestyle=':', linewidth='0.3', color='gray', alpha=0.5)

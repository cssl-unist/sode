...
for CONFIG in "ycsb_a.yaml" "ycsb_b.yaml" "ycsb_c.yaml" "ycsb_d.yaml" "ycsb_e.yaml" "ycsb_f.yaml"; do
    ...
    for NUM_THREADS in 1 2 3; do
        NAME=baseline_tail_${CONFIG}_${CACHE_SIZE}_${NUM_THREADS}
    ...
    CACHE_SIZE=512
    for NUM_THREADS in 1 2 3; do
        NAME=baseline_throughput_${CONFIG}_${CACHE_SIZE}_${NUM_THREADS}
...
for CONFIG in "ycsb_a.yaml" "ycsb_b.yaml" "ycsb_c.yaml" "ycsb_d.yaml" "ycsb_e.yaml" "ycsb_f.yaml"; do
    ...
    CACHE_SIZE=512
    for NUM_THREADS in 1 2 3; do
        NAME=sode_tail_${CONFIG}_${CACHE_SIZE}_${NUM_THREADS}
    ...
    CACHE_SIZE=512
    for NUM_THREADS in 1 2 3; do
        NAME=sode_throughput_${CONFIG}_${CACHE_SIZE}_${NUM_THREADS}
...
for CONFIG in "ycsb_c.yaml"; do
    CACHE_SIZE=512
    NUM_THREADS=1
    NAME=sode_noparallel_${CONFIG}_${CACHE_SIZE}_${NUM_THREADS}
